...
/**
 * Phase 2 — `/exams/[slug]`. ISR, indexed.
 *
...
export async function generateStaticParams() {
  const page = await fetchResources({ kind: "exam", limit: 100 });
...
export async function generateMetadata({
  ...
  return buildMetadata({
    ...
    description: resource.benefit ?? t("examsMetaDescription"),
    canonical: canonicalUrl("https://agri.in", `/exams/${resource.slug}`),
    siteName: "Agri.in",
  });
}
