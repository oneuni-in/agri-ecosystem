...
means the first business in covers() order wins (verified first, then
premium tier, then distance), category-filtered when given. One inquiry ->
one inbox; no fan-out (guest-spam amplification).
